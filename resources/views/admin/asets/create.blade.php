...
@section('content')
    <div class="max-w-2xl mx-auto">
        <div class="bg-slate-800/70 backdrop-blur-sm border border-slate-700 rounded-xl p-6">
            <h2 class="text-xl font-bold text-white mb-6">Tambah Aset Baru</h2>

            <form action="{{ route('admin.asets.store') }}" method="POST" class="space-y-5">
                @csrf
                ...
                <div>
                    ...
                    <select name="status" required
                        ...
                        <option value="Perlu Perbaikan" {{ old('status') == 'Perlu Perbaikan' ? 'selected' : '' }}>Perlu
                            Perbaikan</option>
